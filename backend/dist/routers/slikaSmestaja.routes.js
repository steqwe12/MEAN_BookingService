...
slikaSmestajaRouter.route('/promeniKorisnickoImeNaSlikamaSmestaja').post((req, res) => new slikaSmestaja_controller_1.SlikaSmestajaController().promeniKorisnickoImeNaSlikamaSmestaja(req, res));
